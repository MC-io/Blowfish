...
if __name__ == "__main__":
    ...
    for i in range(0,9):
        ...
        x+=1
        data = temp
    encrypt_data = int(input("Ingresar dato a encriptar: "))
    ...
    print("Dato encriptado = ",data_encrypted)
    print("Dato hexadecimal = ",hex(data_encrypted))
    data_decrypted = decrypt(data_encrypted)
    print("Dato desencriptado = ",data_decrypted) 
